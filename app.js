...
const DaftarPendudukRoute = require("./Master/routes/DaftarPenduduk/DaftarPendudukRoute.js");
const PosyanduLansiaRoute = require("./Master/routes/PosyanduLansia/PosyanduLansiaRoute.js");
const PosyanduBalitaRoute = require("./Master/routes/PosyanduBalita/PosyanduBalitaRoute.js");
...
app.use(DaftarPendudukRoute);
app.use(PosyanduLansiaRoute);
app.use(PosyanduBalitaRoute);
